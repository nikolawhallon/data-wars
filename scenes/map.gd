...
func get_map_origin():
	return Vector2($Walls.get_used_rect().position * $Walls.tile_set.tile_size)

func get_map_size():
	return Vector2($Walls.get_used_rect().size * $Walls.tile_set.tile_size)

func get_tile_size():
	return Vector2($Walls.tile_set.tile_size)
